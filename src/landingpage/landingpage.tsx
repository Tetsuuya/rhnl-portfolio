                ...
                return (
                  <Tilt3D className="rounded-xl">
                    <div className="bg-black/40 border-2 border-white/20 rounded-xl p-6 sm:p-8 backdrop-blur-sm transition-all duration-300 hover:border-pink-300/70 relative overflow-hidden group preserve-3d">
                      ...
                      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 mb-4 border-b border-white/10 pb-4 preserve-3d">
                        <div className="translate-z-20">
                        ...
                        <span className="inline-block px-3 py-1 bg-pink-950/45 border border-pink-700/40 text-xs font-bold text-pink-300 rounded-full translate-z-10">
                          {latestExp.duration}
                        </span>
                      </div>
                      
                      <p className="text-gray-300 text-sm leading-relaxed mb-6 line-clamp-3 whitespace-pre-wrap translate-z-15">
