      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-8 max-w-7xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-7 md:gap-8">
          ...
          <div className="lg:col-span-2">
            <Tilt3D className="h-full rounded-lg">
              <div className="bg-black/40 border-2 border-white/20 rounded-lg p-4 sm:p-5 md:p-6 backdrop-blur-sm transition-all duration-300 hover:border-pink-300/70 h-full preserve-3d">
                <h3 className="text-white text-xl sm:text-2xl font-bold mb-4 sm:mb-5 md:mb-6 translate-z-20">
                  Send a Message
                </h3>
                ...
                {submitStatus.type && (
                  <div
                    className={`mb-4 p-4 rounded-lg translate-z-10 ${
                ...
                <form onSubmit={handleSubmit} className="space-y-4 translate-z-10">
                  <div>
                    <input
                      type="text"
                      name="name"
          ...
          <div className="space-y-6 sm:space-y-7 md:space-y-8">
            ...
            <Tilt3D className="rounded-lg">
              <div className="bg-black/40 border-2 border-white/20 rounded-lg p-4 sm:p-5 md:p-6 backdrop-blur-sm transition-all duration-300 hover:border-pink-300/70 preserve-3d">
                ...
                <div className="space-y-4 sm:space-y-5 md:space-y-6 translate-z-10">
                  {/* Email */}
            ...
            <Tilt3D className="rounded-lg">
              <div className="bg-black/40 border-2 border-white/20 rounded-lg p-4 sm:p-5 md:p-6 backdrop-blur-sm transition-all duration-300 hover:border-pink-300/70 preserve-3d">
                ...
                <ul className="space-y-2 sm:space-y-3 translate-z-10">
